...
namespace MatchingApp.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        private readonly IMatchingAppRepository _matchingAppRepository;
        

        public UsersController(ILogger<UsersController> logger, IMatchingAppRepository matchingAppRepository)
        {
            _logger = logger;
            _matchingAppRepository = matchingAppRepository;
        }
        ...
        /*
            ...
            You should find the top N users (e.g., N = 5) with the highest Credits who are also Active. 
        You should sort the data by Credits in descending order using LINQ.

       */
        [HttpGet]
        public async Task<ActionResult<User>> TopUsersWithHighestCredit()
        {
            var topUsers = _matchingAppRepository.TopUsersWithHighestCredit();
            return Ok(topUsers);
        }
